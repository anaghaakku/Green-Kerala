...
const Contact = () => {
    ...
    // EmailJS Configuration - Updated Credentials
    // IMPORTANT: Replace these with YOUR actual EmailJS credentials
    const EMAILJS_SERVICE_ID = 'service_cwwm10q';     // Your Service ID
    const EMAILJS_TEMPLATE_ID = 'template_bl7gsgd';   // Your Template ID
    const EMAILJS_PUBLIC_KEY = 'lDpMqjfm5yb5QYi9M';   // Your Public Key
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // Method 1: Try EmailJS first (no backend required)
            const templateParams = {
                to_email: 'anaghaakku834@gmail.com',  // Your email where you want to receive messages
                from_name: formData.name,
                from_email: formData.email,
            ...
            // Try Method 2: Save to backend as fallback
            try {
                await axios.post('https://green-kerala-api.onrender.com/api/contact/', formData, {
